...
public class Altimeter extends Region {
    ...
    private void drawPointer10000FtCanvas() {
        ...
        pointer10000FtCtx.moveTo(0.465 * size, 0.5 * size);
        pointer10000FtCtx.bezierCurveTo(0.465 * size, 0.52 * size, 0.48 * size, 0.535 * size, 0.5 * size, 0.535 * size);
        pointer10000FtCtx.bezierCurveTo(0.52 * size, 0.535 * size, 0.535 * size, 0.52 * size, 0.535 * size, 0.5 * size);
        pointer10000FtCtx.bezierCurveTo(0.535 * size, 0.485 * size, 0.525 * size, 0.475 * size, 0.515 * size, 0.47 * size);
        pointer10000FtCtx.bezierCurveTo(0.515 * size, 0.47 * size, 0.515 * size, 0.315 * size, 0.515 * size, 0.315 * size);
        pointer10000FtCtx.lineTo(0.505 * size, 0.3 * size);
        pointer10000FtCtx.lineTo(0.505 * size, 0.125 * size);
        pointer10000FtCtx.lineTo(0.535 * size, 0.08 * size);
        pointer10000FtCtx.lineTo(0.465 * size, 0.08 * size);
        pointer10000FtCtx.lineTo(0.495 * size, 0.125 * size);
        pointer10000FtCtx.lineTo(0.495 * size, 0.3 * size);
        pointer10000FtCtx.lineTo(0.485 * size, 0.315 * size);
        pointer10000FtCtx.bezierCurveTo(0.485 * size, 0.315 * size, 0.485 * size, 0.47 * size, 0.485 * size, 0.47 * size);
        pointer10000FtCtx.bezierCurveTo(0.475 * size, 0.475 * size, 0.465 * size, 0.485 * size, 0.465 * size, 0.5 * size);
